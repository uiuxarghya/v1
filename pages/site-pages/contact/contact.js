...
jQuery, jQuery(document).ready(function(s) {
    ...
    function h(t) {
        ...
        if (t.parents(".tb-text-slider").hasClass("tb-type")) {
            ...
            e.addClass("selected").removeClass("tb-waiting"), setTimeout(function() {
            ...
            ! function t(i, e, n, r) {
                if (i.removeClass("in").addClass("out"), i.is(":last-child") ? n && setTimeout(function() {
                        ...
                        t(i.next(), e, n, r)
                    }, r), i.is(":last-child") && s("html").hasClass("no-csstransitions")) {
                    var l = C(e);
                    m(e, l)
                }
            }(t.find("i").eq(0), t, u, l), b(i.find("i").eq(0), i, u, l)
        } else t.parents(".tb-text-slider").hasClass("clip") ? t.parents(".tb-words-wrapper").animate({
            width: "2px"
        }, p, function() {
            m(t, i), f(i)
        }) : t.parents(".tb-text-slider").hasClass("loading-bar") ? (t.parents(".tb-words-wrapper").removeClass("is-loading"), m(t, i), setTimeout(function() {
            h(i)
        }, n), setTimeout(function() {
            t.parents(".tb-words-wrapper").addClass("is-loading")
        }, r)) : (m(t, i), setTimeout(function() {
            h(i)
        }, a))
    }

    function f(s, t) {
        s.parents(".tb-text-slider").hasClass("tb-type") ? (b(s.find("i").eq(0), s, !1, t), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".tb-text-slider").hasClass("clip") && s.parents(".tb-words-wrapper").animate({
            width: s.width() + 10
        }, p, function() {
            setTimeout(function() {
                h(s)
    ...
    function b(s, t, i, e) {
        s.addClass("in").removeClass("out"), s.is(":last-child") ? (t.parents(".tb-text-slider").hasClass("tb-type") && setTimeout(function() {
    ...
    function m(s, t) {
        s.removeClass("is-visible").addClass("is-hidden"), t.removeClass("is-hidden").addClass("is-visible")
    }
    s(".tb-text-slider.tb-letters").find("b").each(function() {
        var t = s(this),
            e = t.text().split(""),
        ...
        var t = s(this);
        if (t.hasClass("loading-bar")) e = n, setTimeout(function() {
